    ...
    <div className="min-h-screen bg-white">
      <section data-hero-section className="relative overflow-hidden bg-black text-white aspect-auto md:aspect-[16/5] min-h-[320px] md:min-h-0 flex items-center">
        ...
        <div className="relative mx-auto max-w-[1200px] px-6 py-16 md:py-0 w-full flex flex-col items-center justify-center text-center">
          ...
          <h1 className="text-[28px] sm:text-[36px] md:text-[56px] font-semibold leading-tight md:leading-[1.05] max-w-4xl mx-auto">
      ...
      <section className="relative w-full overflow-visible">
        <TopPageNav />
        <div className="w-full px-4 md:px-8 lg:px-12 py-12 bg-white">
