    ...
    <div className="min-h-screen bg-white">
      ...
      <section data-hero-section className="relative bg-black text-white aspect-[16/5] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1200px] px-6 text-center">
          <p className="text-[12px] uppercase tracking-[0.35em] text-white/60 mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>
            Platform Values
          </p>
          <motion.h1 
      ...
      <section className="relative w-full overflow-visible">
        <div className="flex w-full items-start gap-0">
          ...
          <div className="flex-1 min-w-0 px-4 md:px-8 py-12 max-w-[1400px] mx-auto">
            <div className="mb-10">
          <p className="text-[12px] uppercase tracking-[0.24em] text-black/40 mb-2" style={{ fontFamily: 'Poppins, sans-serif' }}>
            Our Principles
          </p>
          <h2
          ...
          >
            ...
            <div className="max-w-[940px] space-y-10 text-black/80 leading-relaxed" style={{ fontFamily: 'Poppins, sans-serif' }}>
