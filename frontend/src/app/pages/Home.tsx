      ...
      >
        ...
        <div className="relative w-full max-w-[90vw] px-4 sm:px-6">
          <motion.h1
            ...
            className="relative w-full text-[36px] sm:text-[40px] md:text-[46px] text-bottom leading-[1.05] sm:leading-tight px-0 md:px-8 max-w-full md:max-w-none z-10 font-sans font-semibold"
